...
/*
Package trustregistry is a reverse proxy.
...
var (
	...
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"trustregistry", "v1", "params"}, "", runtime.AssumeColonVerbOpt(false)))
)
