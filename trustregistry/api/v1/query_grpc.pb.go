...
const (
	Query_GetTrustRegistry_FullMethodName = "/pratikasr.trustregistry.v1.Query/GetTrustRegistry"
	Query_Params_FullMethodName           = "/pratikasr.trustregistry.v1.Query/Params"
)
